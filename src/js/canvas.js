...
class Player {
    ...
    draw() {
        c.drawImage(
            this.currentSprite,
            this.currentCropWidth * this.frames,//top
            0,//left
            this.currentCropWidth,//width of first image in sprite
            400,//height of first image 
            this.position.x, 
            this.position.y, 
            this.width, 
            this.height
    ...
    if(difference > 1000 / fps) {
        ...
        if (keys.right.pressed && player.position.x < 400) {
            player.velocity.x = player.speed
                  ...
                  (keys.left.pressed && player.position.x > 100) || //Or statement
